...
<body class="bg-light">
    ...
    <div class="container-fluid px-0"> <!-- container-fluid with no horizontal padding -->
        <img src="{{ asset('images/web/1.jpg') }}" alt="Extended Image" class="img-fluid w-100"> <!-- Full-width image -->
    </div>
        ...
        @else
            <ul class="list-unstyled">
                @foreach ($courses as $course)
                    <li class="d-flex mb-2 my-2 p-3 border-bottom">
